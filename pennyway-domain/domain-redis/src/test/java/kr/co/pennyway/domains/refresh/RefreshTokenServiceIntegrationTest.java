package kr.co.pennyway.domains.refresh;
...
import kr.co.pennyway.domain.domains.refresh.service.RefreshTokenRedisServiceImpl;
...
@ContextConfiguration(classes = {RedisConfig.class, LettuceConfig.class, RefreshTokenRedisServiceImpl.class})
@ActiveProfiles("test")
public class RefreshTokenServiceIntegrationTest extends ContainerRedisTestConfig {
    ...
    @BeforeEach
    void setUp() {
        this.refreshTokenService = new RefreshTokenRedisServiceImpl(refreshTokenRepository);
    }
