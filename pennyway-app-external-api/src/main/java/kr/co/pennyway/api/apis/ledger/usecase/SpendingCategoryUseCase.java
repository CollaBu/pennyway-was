...
public class SpendingCategoryUseCase {
    ...
    @Transactional
    public SpendingCategoryDto.Res updateSpendingCategory(Long userId, Long categoryId, SpendingCategoryType type) {
        SpendingCustomCategory category = spendingCategorySaveService.update(userId, categoryId, type);
